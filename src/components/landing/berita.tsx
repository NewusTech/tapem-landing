...
//           <div className="flex flex-col items-start justify-center gap-6 bg-gradient-to-b from-primary-soft to-primary-700 p-10 h-[35rem] w-full md:w-[60%] rounded-2xl overflow-hidden">
...
//                           <p className="text-primary-main text-xl line-clamp-3 font-bold">
//                             {data.title}
//                           </p>
        ...
        <div className="flex flex-row mt-10 relative">
          ...
          <div className=" h-full w-full md:w-[65%] lg:w-[75%] absolute -right-3 lg:-right-6 flex items-center ">
            <Carousel
              ...
              className="w-full md:w-[95%] lg:w-[90%] xl:w-[95%] 2xl:w-full"
              setApi={setCaroselApiWeb}
            >
              <CarouselContent>
                {newsList &&
                  ...
                  newsList.map((data, index) => (
                    <CarouselItem
                      key={index + "berita"}
                      className=" md:basis-[65%] lg:basis-[45%] 2xl:basis-[32%] py-5"
                    >
